...
/***/ "./markup/components/empty-state/empty-state.ts":
/*!******************************************************!*\
  !*** ./markup/components/empty-state/empty-state.ts ***!
  \******************************************************/
...
/* harmony export */   renderEmptyState: () => (/* binding */ renderEmptyState)
/* harmony export */ });
function renderEmptyState() {
    ...
    <div class="empty-state">
      ...
      <h2 class="empty-state-title">В избранном пока ничего нет</h2>
      <p class="empty-state-description">Добавляйте понравившиеся товары в избранное, чтобы не потерять их и сравнить между собой</p>
      <a href="/catalog" class="btn btn-primary" data-gtm="go-to-catalog">Перейти в каталог</a>
    </div>
  `;
}
...
/***/ "./markup/components/product-card/product-card.ts":
/*!********************************************************!*\
  !*** ./markup/components/product-card/product-card.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderFavoritesGrid: () => (/* binding */ renderFavoritesGrid),
/* harmony export */   renderProductCard: () => (/* binding */ renderProductCard)
/* harmony export */ });
const renderRating = (productId, rating, reviewsCount) => {
    const fullStars = Math.floor(rating);
    const halfStar = rating % 1 >= 0.5;
    const emptyStars = 5 - fullStars - (halfStar ? 1 : 0);
    const starPath = 'M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z';
    const createStarSvg = (fill) => `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
        <path d="${starPath}" fill="${fill}" />
      </svg>
    `;
    const createHalfStarSvg = (gradientId) => `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
        <defs>
    ...
    const starsHtml = stars
        .map((type, index) => {
        if (type === 'full') {
            return `<span class="star star--full" aria-hidden="true">${createStarSvg('#FDB022')}</span>`;
        }
        if (type === 'half') {
            const gradientId = `star-grad-${productId}-${index}`;
            return `<span class="star star--half" aria-hidden="true">${createHalfStarSvg(gradientId)}</span>`;
        }
        return `<span class="star star--empty" aria-hidden="true">${createStarSvg('#E0E4EF')}</span>`;
    })
        .join('');
    const reviewsLabel = typeof reviewsCount === 'number' ? reviewsCount.toLocaleString('ru-RU') : null;
    return `
...
const renderSizeSelect = (productId, sizes, inStock) => {
    if (sizes.length === 0)
        return '';
    ...
    return `
      <div class="size-select">
        ...
        <select id="${selectId}" class="form-select" aria-label="Выберите размер" data-product-available="${inStock}" ${inStock ? '' : 'disabled'}>
...
const renderFavoritesGrid = (products) => {
...
/***/ "./markup/components/subscribe-modal/subscribe-modal.ts":
/*!**************************************************************!*\
  !*** ./markup/components/subscribe-modal/subscribe-modal.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderSubscribeModal: () => (/* binding */ renderSubscribeModal)
/* harmony export */ });
...
/***/ "./markup/components/subscribe-modal/success-modal.ts":
/*!************************************************************!*\
  !*** ./markup/components/subscribe-modal/success-modal.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderSuccessModal: () => (/* binding */ renderSuccessModal)
/* harmony export */ });
...
/***/ "./markup/pages/personal/favorites.ts":
/*!********************************************!*\
  !*** ./markup/pages/personal/favorites.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_product_card_product_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/product-card/product-card */ "./markup/components/product-card/product-card.ts");
/* harmony import */ var _components_empty_state_empty_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/empty-state/empty-state */ "./markup/components/empty-state/empty-state.ts");
/* harmony import */ var _components_subscribe_modal_subscribe_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/subscribe-modal/subscribe-modal */ "./markup/components/subscribe-modal/subscribe-modal.ts");
/* harmony import */ var _components_subscribe_modal_success_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/subscribe-modal/success-modal */ "./markup/components/subscribe-modal/success-modal.ts");
...
const fetchFavorites = (url) => jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(url);
class FavoritesManager {
    constructor() {
        this.products = [];
        this.$favoritesContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#favoritesContent');
        this.init();
    }
    init() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#subscribeModalContainer').html((0,_components_subscribe_modal_subscribe_modal__WEBPACK_IMPORTED_MODULE_3__.renderSubscribeModal)() + (0,_components_subscribe_modal_success_modal__WEBPACK_IMPORTED_MODULE_4__.renderSuccessModal)());
        this.loadFavorites();
        this.bindEvents();
    }
    loadFavorites() {
        ...
        fetchFavorites(dataUrl)
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#favoritesCount').text(totalFavorites.toString());
    ...
    bindEvents() {
        this.$favoritesContent.on('click', '.btn-remove', (e) => this.handleRemoveProduct(e));
        this.$favoritesContent.on('click', '[data-gtm="add-to-cart"]', (e) => this.handleAddToCart(e));
        this.$favoritesContent.on('change', '.size-select .form-select', (e) => {
            this.updateSizeSelectState(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget));
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '[data-bs-target="#subscribeModal"]', (e) => this.handleOpenSubscribeModal(e));
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#submitSubscribe').on('click', () => this.handleSubmitSubscribe());
    }
    renderFavoritesPage() {
        if (!this.products || this.products.length === 0) {
            this.$favoritesContent.html((0,_components_empty_state_empty_state__WEBPACK_IMPORTED_MODULE_2__.renderEmptyState)());
            return;
        }
        const productsHtml = (0,_components_product_card_product_card__WEBPACK_IMPORTED_MODULE_1__.renderFavoritesGrid)(this.products);
        this.$favoritesContent.html(productsHtml);
        this.$favoritesContent.find('.size-select .form-select').each((_, element) => {
            this.updateSizeSelectState(jquery__WEBPACK_IMPORTED_MODULE_0___default()(element));
        });
    }
    handleRemoveProduct(event) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#favoritesCount').text(this.products.length.toString());
    ...
    handleAddToCart(event) {
        ...
        const $cartCount = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#cartCount');
        const currentCount = parseInt($cartCount.text(), 10) || 0;
        $cartCount.text((currentCount + 1).toString());
        console.info(`Товар "${product.title}" (ID: ${product.id}, размер: ${selectedSizeValue}) добавлен в корзину`);
    }
    handleOpenSubscribeModal(event) {
        const $button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.currentTarget);
        const productId = parseInt($button.data('product-id'));
        const product = this.findProductById(productId);
        if (!product)
            return;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-product-id').val(product.id);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-product-brand').text(product.brand);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-product-title').text(product.title);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-product-price').text(new Intl.NumberFormat('ru-RU').format(product.price) + ' ₽');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-product-image').attr('src', product.image).attr('alt', product.title);
        const $sizeSelect = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#subscribeSize');
        ...
        if (form) {
            form.reset();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(form).removeClass('was-validated');
        }
        console.info(`Открыто модальное окно подписки для товара "${product.title}" (ID: ${product.id})`);
    }
    handleSubmitSubscribe() {
        ...
        const productId = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-product-id').val();
        const size = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#subscribeSize').val();
        const phone = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#subscribePhone').val();
        const agreeTerms = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#agreeTerms').prop('checked');
        if (!agreeTerms) {
            return;
        }
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _pages_personal_favorites__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pages/personal/favorites */ "./markup/pages/personal/favorites.ts");
